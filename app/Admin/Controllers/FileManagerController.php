...
//            }
    ...
    public function upload(Request $request)
    {
        ...
        $file_name = $request->file()['fileModalImage']->getClientOriginalName();
        ...
        try {
            $request->file()['fileModalImage']->storeAs($this->path . $directory, $file_name);
        } catch (\Exception $e) {
        ...
        $imgInfo = getimagesize($request->file()['fileModalImage']->path());
