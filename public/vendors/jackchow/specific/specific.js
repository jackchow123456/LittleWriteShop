(function () {
    ...
    Specific.prototype.buildSpecificBoxHtml = function () {
        var html = '<div class="box box-default box-solid" style="margin: 15px 0">\n' +
            ...
            '                    <div class="input-group specific_value">\n' +
            '                        <div class="input-group-btn">\n' +
    ...
    Specific.prototype.buildValueHtml = function () {
        var html = '<div class="input-group col-sm-4 specific_value">\n' +
            '                        <div class="input-group-btn">\n' +
